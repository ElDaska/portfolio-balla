    ...
    <header className="w-full bg-[#0f172a]/95 border-b border-white/10 backdrop-blur-xl sticky top-0 z-50 shadow-lg shadow-black/20">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <a
          ...
          className="hidden md:flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-sm font-semibold text-white transition-all shadow-lg hover:shadow-blue-500/50 hover:scale-105"
        >
