      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div className="text-sm md:text-base text-gray-300 space-y-4">
          ...
          <p>
            ...
            <span className="text-amber-400 font-medium">remote internationales</span>,
          ...
          <div className="space-y-4 text-gray-300 text-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="mailto:diop.ehb@gmail.com" className="text-white hover:text-amber-400 font-medium">
                  diop.ehb@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="tel:+212609685667" className="text-white font-medium hover:text-green-400">
                  +212 6 09 68 56 67
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="https://www.linkedin.com/in/elhadjiballadiop" target="_blank" rel="noreferrer" className="text-white font-medium hover:text-amber-400">
                  /elhadjiballadiop
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white font-medium">Fès, Maroc — Remote international</p>
              </div>
            </div>
          </div>
        </div>
